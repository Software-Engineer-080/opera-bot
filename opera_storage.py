...
opera_link = "[Яндекс карты](https://yandex.ru/maps/org/52896029199)"
...
user_menu = ["👤Профиль", "Резерв 🔏", "🍽 Меню️", "Новинки 🔥", "🎁 Акции", "Отзыв 💬", "⚡️Мероприятия⚡️"]
...
food_menu = ["🍻 Бар", "Коктейли 🍹", "🍝 Кухня", "Десерты 🍰", "Главное меню"]
